...
-- -- Supplier Users
-- VALUES
-- (2, false, NOW(), true, 1, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'SUPPLIER', NOW(), 'techsupply_admin'),
-- (3, false, NOW(), true, 2, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'SUPPLIER', NOW(), 'homegoods_admin'),
-- (4, false, NOW(), true, 3, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'SUPPLIER', NOW(), 'officedepot_admin'),
-- (5, false, NOW(), true, 4, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'SUPPLIER', NOW(), 'globalelectronics_admin'),
-- -- Retailer Users  
-- (6, false, NOW(), true, 1, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'RETAILER', NOW(), 'bestbuy_buyer'),
-- (7, false, NOW(), true, 2, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'RETAILER', NOW(), 'homestyle_buyer'),
-- (8, false, NOW(), true, 5, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'RETAILER', NOW(), 'corpsolutions_buyer'),
-- (9, false, NOW(), true, 4, 0, NULL, '$2a$10$N9qo8uLOickgx2ZMRZoMyeaRRf8oEa7jvV2V6yfKH.Y0C5tl6EL1u', 'RETAILER', NOW(), 'techmart_buyer');
...
-- (507, 'TechSupply Electronics', 'contact@techsupply.com', '+1-555-0101', '123 Tech Street, Silicon Valley, CA 94000', 
...
-- (508, 'HomeGoods Wholesale', 'sales@homegoods.com', '+1-555-0202', '456 Home Ave, Portland, OR 97000',
...
-- (509, 'Office Depot Wholesale', 'orders@officedepot.com', '+1-555-0303', '789 Office Blvd, Seattle, WA 98000',
...
-- (510, 'Global Electronics Hub', 'wholesale@globalelectronics.com', '+1-555-0404', '100 Innovation Drive, Austin, TX 78701',
...
-- (4, 'BestBuy Downtown', 'purchasing@bestbuy-dt.com', '+1-555-1001', '321 Retail Plaza, New York, NY 10001',
...
-- (5, 'HomeStyle Retail Chain', 'orders@homestyle.com', '+1-555-1002', '654 Shopping Center, Los Angeles, CA 90001',
...
-- (6, 'Corporate Office Solutions', 'procurement@corpsolutions.com', '+1-555-1003', '987 Business Park, Chicago, IL 60601',
...
-- (7, 'TechMart Express', 'buying@techmart.com', '+1-555-1004', '789 Technology Way, Seattle, WA 98101',
...
-- (91, 'TECH-LAPTOP-001', 'Business Laptop Pro 15"', 'High-performance laptop with Intel i7 processor, 16GB RAM, 512GB SSD. Perfect for business use with enterprise security features.', 
--  1, 1299.99, 5, 'piece', NOW(), NOW()),

-- (92, 'TECH-MOUSE-001', 'Ergonomic Wireless Mouse', 'Comfortable wireless mouse with 6 programmable buttons, precision tracking, and 18-month battery life.', 
--  1, 49.99, 25, 'piece', NOW(), NOW()),

-- (93, 'TECH-KEYBOARD-001', 'Mechanical Wireless Keyboard', 'Professional mechanical keyboard with RGB backlighting and programmable keys for productivity.', 
--  1, 149.99, 15, 'piece', NOW(), NOW()),

-- -- HomeGoods Wholesale Products  
-- (94, 'HOME-LAMP-001', 'Modern LED Desk Lamp', 'Adjustable LED desk lamp with USB charging port, touch controls, and energy-efficient design.', 
--  2, 79.99, 20, 'piece', NOW(), NOW()),

-- (95, 'HOME-CHAIR-001', 'Executive Office Chair', 'Ergonomic leather office chair with lumbar support, adjustable height, and premium cushioning.', 
--  2, 449.99, 10, 'piece', NOW(), NOW()),

-- (96, 'HOME-DESK-001', 'Standing Desk Converter', 'Adjustable height desk converter for ergonomic workspace setup. Easy assembly and sturdy construction.', 
--  2, 299.99, 8, 'piece', NOW(), NOW()),

-- -- Office Depot Wholesale Products
-- (97, 'OFFICE-PAPER-001', 'Premium A4 Paper', 'High-quality white A4 paper, 80gsm weight, 500 sheets per ream. Perfect for professional documents.', 
--  3, 8.99, 100, 'ream', NOW(), NOW()),

-- (98, 'OFFICE-ORG-001', 'Bamboo Desk Organizer', 'Eco-friendly desk organizer with multiple compartments for pens, paper clips, and office supplies.', 
--  3, 34.99, 50, 'piece', NOW(), NOW()),

-- (99, 'OFFICE-BIND-001', 'Professional Binder Set', 'Set of 5 premium binders with clear overlay and durable construction for document organization.', 
--  3, 24.99, 40, 'set', NOW(), NOW()),

-- -- Global Electronics Hub Products
-- (100, 'GLOBAL-TAB-001', 'Business Tablet 10"', 'Professional-grade tablet with stylus, keyboard case, and business applications suite.', 
...
-- (1, 91, 'TECH-LAPTOP-001-I5', 'Silver', '15"', -200.00, NOW(), NOW()),  -- Base i5 model
-- (2, 91, 'TECH-LAPTOP-001-I7', 'Silver', '15"', 0.00, NOW(), NOW()),     -- Standard i7 model  
-- (3, 91, 'TECH-LAPTOP-001-I7-BLACK', 'Black', '15"', 50.00, NOW(), NOW()); -- Premium black

-- -- -- Mouse variants (different colors)
-- INSERT INTO product_variants (id, product_id, sku, color, size, price_adjustment, created_at, updated_at) VALUES 
-- (4, 92, 'TECH-MOUSE-001-BLK', 'Black', 'Standard', 0.00, NOW(), NOW()),
-- (5, 92, 'TECH-MOUSE-001-WHT', 'White', 'Standard', 5.00, NOW(), NOW()),
-- (6, 92, 'TECH-MOUSE-001-GRY', 'Grey', 'Standard', 0.00, NOW(), NOW());

-- -- -- Keyboard variants  
-- INSERT INTO product_variants (id, product_id, sku, color, size, price_adjustment, created_at, updated_at) VALUES 
-- (7, 93, 'TECH-KEY-001-BLK', 'Black', 'Full Size', 0.00, NOW(), NOW()),
-- (8, 93, 'TECH-KEY-001-WHT', 'White', 'Full Size', 10.00, NOW(), NOW());

UPDATE product_variants SET product_id = 90 + product_id WHERE id < 9;
...
-- INSERT INTO product_variants (id, product_id, sku, color, size, price_adjustment, created_at, updated_at) VALUES 
-- (14226, 6, 'HOME-DESK-001-STD', 'Oak', 'Standard', 0.00, NOW(), NOW()),
-- (14227, 7, 'OFFICE-PAPER-001-WHT', 'White', '500 sheets', 0.00, NOW(), NOW()),
-- (14228, 8, 'OFFICE-ORG-001-NAT', 'Natural', 'Standard', 0.00, NOW(), NOW()),
-- (14229, 9, 'OFFICE-BIND-001-BLK', 'Black', '2-inch', 0.00, NOW(), NOW()),
-- (14230, 10, 'GLOBAL-TAB-001-BLK', 'Black', '10-inch', 0.00, NOW(), NOW()),
-- (14231, 10, 'GLOBAL-TAB-001-WHT', 'White', '10-inch', 25.00, NOW(), NOW());
...
-- Laptop bulk pricing
-- INSERT INTO price_tiers (id, product_id, min_quantity, max_quantity, discount_percent) VALUES 
-- (1, 1, 10, 49, 5.0),    -- 5% off for 10-49 units
-- (2, 1, 50, NULL, 10.0); -- 10% off for 50+ units

-- -- Mouse bulk pricing  
-- INSERT INTO price_tiers (id, product_id, min_quantity, max_quantity, discount_percent) VALUES 
-- (3, 2, 25, 99, 3.0),    -- 3% off for 25-99 units
-- (4, 2, 100, NULL, 8.0); -- 8% off for 100+ units

-- -- Paper bulk pricing (high volume product)
-- INSERT INTO price_tiers (id, product_id, min_quantity, max_quantity, discount_percent) VALUES 
-- (5, 7, 200, 499, 5.0),   -- 5% off for 200-499 reams  
-- (6, 7, 500, 999, 10.0),  -- 10% off for 500-999 reams
-- (7, 7, 1000, NULL, 15.0); -- 15% off for 1000+ reams
...
-- (14234, 1, 91, 1, 4500, 5, 20, 50, 'Warehouse A-1', NOW() - INTERVAL 5 DAY, NOW(), 'AVAILABLE'),
-- (14235, 1, 91, 2, 8000, 10, 30, 100, 'Warehouse A-1', NOW() - INTERVAL 3 DAY, NOW(), 'AVAILABLE'),  
-- (14236, 1, 91, 3, 2500, 0, 15, 30, 'Warehouse A-1', NOW() - INTERVAL 7 DAY, NOW(), 'AVAILABLE'),
-- (14237, 1, 92, 4, 20000, 25, 50, 200, 'Warehouse A-2', NOW() - INTERVAL 2 DAY, NOW(), 'AVAILABLE'),
-- (14238, 1, 92, 5, 15000, 15, 40, 150, 'Warehouse A-2', NOW() - INTERVAL 4 DAY, NOW(), 'AVAILABLE'),
-- (14239, 1, 93, 7, 7000, 5, 25, 100, 'Warehouse A-2', NOW() - INTERVAL 6 DAY, NOW(), 'AVAILABLE'),

-- -- HomeGoods inventory
-- (14240, 2, 94, 9, 6000, 5, 20, 50, 'Warehouse B-1', NOW() - INTERVAL 1 DAY, NOW(), 'AVAILABLE'),
-- (14241, 2, 94, 10, 4000, 0, 15, 30, 'Warehouse B-1', NOW() - INTERVAL 8 DAY, NOW(), 'AVAILABLE'),
-- (14242, 2, 95, 11, 3500, 3, 10, 25, 'Warehouse B-2', NOW() - INTERVAL 5 DAY, NOW(), 'AVAILABLE'),
-- (14243, 2, 95, 12, 2800, 2, 8, 20, 'Warehouse B-2', NOW() - INTERVAL 7 DAY, NOW(), 'AVAILABLE'),

-- -- Office Depot inventory  
-- (14244, 3, 97, 14227, 5000, 200, 1000, 2000, 'Warehouse C-1', NOW() - INTERVAL 1 DAY, NOW(), 'AVAILABLE'),
-- (14245, 3, 98, 14228, 12000, 10, 30, 100, 'Warehouse C-2', NOW() - INTERVAL 3 DAY, NOW(), 'AVAILABLE'),
-- (14246, 3, 99, 14229, 8500, 5, 25, 50, 'Warehouse C-2', NOW() - INTERVAL 4 DAY, NOW(), 'AVAILABLE');
