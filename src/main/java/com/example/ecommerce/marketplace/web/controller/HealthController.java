...
/**
 * Health check and user registration controller.
 * Provides system health status and user account registration endpoints.
 */
@RestController
@RequestMapping("/api/v1/health")
@RequiredArgsConstructor
@Tag(name = "Health & Registration", description = "Health check and user registration API")
public class HealthController {
     ...
     */
    @PostMapping("/users/register/supplier")
    @Transactional
     ...
     */
    @PostMapping("/users/register/retailer")
    @Transactional
